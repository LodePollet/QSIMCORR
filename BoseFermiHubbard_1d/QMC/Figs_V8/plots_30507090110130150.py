...
data_110 = np.loadtxt("pw_L110")
data_130 = np.loadtxt("pw_L130")
...
plt.errorbar(data_70[:,1], data_70[:,5],yerr = np.ones_like(data_70[:,1])*0.15, fmt='bo-.')
plt.errorbar(data_70[:,1], data_70[:,6],yerr = np.ones_like(data_70[:,1])*0.15, fmt='mx-.')
