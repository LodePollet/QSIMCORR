...
plt.figure()
#plt.plot(data_30[1:,1], data_30[1:,-1], 'rs-', label="L=30")
#plt.plot(data_50[1:,1], data_50[1:,-1], 'bo-', label="L=50")
#plt.plot(data_70[1:,1], data_70[1:,-1], 'mx-', label="L=70")
#plt.plot(data_110[1:,1], data_110[1:,-1], 'kx-', label="L=110")
#plt.plot(data_150[1:,1], data_150[1:,-1], 'yx-', label="L=150")
...
plt.errorbar(data_110[1:,1], data_110[1:,-1], yerr = 0.01*np.ones_like(data_110[1:,1]), fmt='kx-', label="L=110")
...
plt.errorbar(data_90[:,1], data_90[:,4], yerr=data_90[:,5], fmt='gd-', label="L=90")
...
plt.errorbar(data_90[:,1], data_90[:,6], yerr=data_90[:,7], fmt='gd-', label="L=90")
...
plt.errorbar(data_90[:,1], data_90[:,8], yerr=data_90[:,9], fmt='gd-', label="L=90")
...
plt.errorbar(data_90[:,1], data_90[:,10], yerr=data_90[:,11], fmt='gd-', label="L=90")
...
plt.errorbar(data_90[:,1], data_90[:,12], yerr=data_90[:,13], fmt='gd-', label="L=90")
...
plt.errorbar(data_90[:,1], (data_90[:,10] - data_90[:,12])/4., yerr=data_90[:,13], fmt='gd-', label="L=90")
