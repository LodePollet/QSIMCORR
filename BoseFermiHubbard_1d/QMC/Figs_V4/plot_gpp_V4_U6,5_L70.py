...
data = np.loadtxt("stat_dens_V4_U6,5_L70.out")
xpp = data[:,0]
gpp = data[:,15]
gpp_err = data[:,16]
gph = data[:,13]
...
cdw_data = np.loadtxt("stat_cdwsdw_V4_U6,5_L70.out")
xcdw = cdw_data[:,0]
cdw = cdw_data[:,1]
...
plt.savefig("fig_pp_V4_U6,5_L70.pdf", format="pdf")
...
plt.savefig("fig_cdw_V4_U6,5_L70.pdf", format="pdf")
