...
cdw_data30 = np.loadtxt("stat_cdwsdw_V6_U11_L30.out")
cdw_data50 = np.loadtxt("stat_cdwsdw_V6_U11_L50.out")
cdw_data70 = np.loadtxt("stat_cdwsdw_V6_U11_L70.out")
cdw_data90 = np.loadtxt("stat_cdwsdw_V6_U11_L90.out")
cdw_data110 = np.loadtxt("stat_cdwsdw_V6_U11_L110.out")
cdw_data130 = np.loadtxt("stat_cdwsdw_V6_U11_L130.out")
cdw_data150 = np.loadtxt("stat_cdwsdw_V6_U11_L150.out")
xcdw30 = cdw_data30[:,0]
L30 = xcdw30.size
cdw30 = cdw_data30[:,1]
...
plt.savefig("fig_cdw_V6_U11_FSS.pdf", format="pdf", bbox_inches="tight")
