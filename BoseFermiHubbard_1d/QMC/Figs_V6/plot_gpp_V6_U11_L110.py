...
plt.plot(xcdw_fit, f(xcdw_fit, *popt_cdw), "c--", label = r"$fit, \eta_{cdw} \approx  %2.2f$" %(popt_cdw[0]))
plt.plot(xcdw_fit, fconst(xcdw_fit, *popt_cdw_const), "r--", label = r"$fit, C \approx  %3.3f$" %(popt_cdw_const[2]))
...
plt.savefig("fig_cdw_V6_U11_L110.pdf", format="pdf", bbox_inches="tight")
