...
data_90 = np.loadtxt("powerlaw_L110")
data_90 = np.loadtxt("powerlaw_L130")
...
#plt.xticks(fontsize=16)
#plt.yticks(fontsize=16)
#plt.savefig("fig_powerlaw_densmat.pdf", format="pdf", bbox_inches="tight")
...
##plt.plot(data_110[:,1], data_110[:,4], 'rs-', label="L=110, boson")
##plt.plot(data_110[:,1], data_110[:,5], 'bo:', label=r"$L=110, \eta_{\rm CDW}$")
##plt.plot(data_110[:,1], data_110[:,6], 'mx:', label=r"$L=110, \eta_{\rm SDW}$")
##plt.plot(data_130[:,1], data_130[:,4], 'rs-', label="L=130, boson")
##plt.plot(data_130[:,1], data_130[:,5], 'bo:', label=r"$L=130, \eta_{\rm CDW}$")
##plt.plot(data_130[:,1], data_130[:,6], 'mx:', label=r"$L=130, \eta_{\rm SDW}$")
...
#plt.xlabel("U", fontdict=font1)
##plt.ylabel("power law exponents", fontdict=font1)
#plt.ylabel(r"$\eta_{\rm CDW}, \eta_{\rm SDW}$, \eta{\rm bb}", fontdict=font1)
##plt.legend(loc="best", fontsize=16)
##plt.savefig("fig_powerlaw_densmat.pdf", format="pdf")
#plt.savefig("fig_Luttinger.pdf", format="pdf")
...
plt.errorbar(data_70[:,1], data_70[:,5],yerr = np.ones_like(data_70[:,1])*0.04, fmt='bo-.')
plt.errorbar(data_70[:,1], data_70[:,6],yerr = np.ones_like(data_70[:,1])*0.04, fmt='mx-.')
#plt.plot(data_90[:,1], data_90[:,4], 'rs:', label="L=90, boson")
#plt.plot(data_90[:,1], data_90[:,5], 'bo:', label=r"$L=90, \eta_{\rm CDW}$")
#plt.plot(data_90[:,1], data_90[:,6], 'mx:', label=r"$L=90, \eta_{\rm SDW}$")
#plt.plot(data_150[:,1], data_150[:,4], 'rs-', label="L=150, boson")
...
plt.errorbar(data_30[0:5,1], data_30[0:5,4], yerr = np.ones_like(data_30[0:5,1])*0.02, fmt='cs-', label=r"$\eta_{\rm bb}$")
plt.errorbar(data_50[0:5,1], data_50[0:5,4], yerr = np.ones_like(data_50[0:5,1])*0.03, fmt='cs--')
plt.errorbar(data_70[0:5,1], data_70[0:5,4],yerr = np.ones_like(data_70[0:5,1])*0.04, fmt='cs-.')
