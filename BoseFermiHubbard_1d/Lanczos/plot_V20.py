...
d4 = np.loadtxt("./L4/V20/stat.txt")
d6 = np.loadtxt("./L6/V20/stat.txt")
d8 = np.loadtxt("./L8/V20/stat.txt")
...
#plt.ylabel(r"$O_{\rm ps}, O_{\rm CDW}$", fontdict=font1)
plt.savefig("fig_Lanczos_V20.pdf", format="pdf", bbox_inches="tight")
